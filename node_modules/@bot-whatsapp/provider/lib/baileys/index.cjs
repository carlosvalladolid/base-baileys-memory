    ...
    busEvents = () => [
        {
            ...
            func: ({ messages, type }) => {
                ...
                // y hay que poner otr condición, dejo las anteriores por si cambia entre diferentes números de Carbyne
                // Última modificación 11 Julio 2024
                if (payload.body == '' || payload.body == null) {
                    console.log("Body1: " + messageCtx?.message?.templateMessage?.hydratedTemplate?.hydratedContentText)
                    payload.body = messageCtx?.message?.templateMessage?.hydratedTemplate?.hydratedContentText;
                }

                if (payload.body == '' || payload.body == null) {
                    console.log("Body2: " + messageCtx?.message?.highlyStructuredMessage?.localizableParams[1]?.default)
                    payload.body = messageCtx?.message?.highlyStructuredMessage?.localizableParams[1]?.default;
                }

                if (payload.body == '' || payload.body == null) {
                    console.log("Body3: " + messageCtx?.message?.highlyStructuredMessage?.hydratedHsm?.hydratedTemplate?.hydratedContentText)
